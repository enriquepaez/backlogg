...
class Movie(Base):
    ...
    # by ``idx_movies_search_vector``.  It replaces the ``catalog_search``
    ...
    # ``select(Movie)`` in the codebase would drag the vector along.
    ...
    __table_args__ = (
        ...
        Index("idx_movies_search_vector", "search_vector", postgresql_using="gin"),
    )
