...
class Series(Base):
    ...
    # by ``idx_series_search_vector``.  It replaces the ``catalog_search``
    ...
    # ``select(Series)`` in the codebase would drag the vector along.
    ...
    __table_args__ = (
        ...
        Index("idx_series_search_vector", "search_vector", postgresql_using="gin"),
    )
